...
mod tests {
    ...
    mod disputes {
        ...
        #[test]
        fn test_dispute_with_existing_deposit() {
            let client_1 = 1_001;
        ...
        #[test]
        fn test_dispute_transaction_of_another_client() {
            let client_1 = 1_001;
            let client_2 = 1_002;
        ...
        #[test]
        fn test_dispute_existing_but_incorrect_transaction() {
            let client_1 = 1_001;
        ...
        #[test]
        fn test_dispute_existing_transaction_but_insufficient_balance() {
            let client_1 = 1_001;
