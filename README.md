...
1. In this interpretation of disputes, i.e., when mandated from an outside payment processor even if less money is available than the dispute would demand, the available account balance becomes negative. This means, if charged back, the payment operator implemented here would lose money.
